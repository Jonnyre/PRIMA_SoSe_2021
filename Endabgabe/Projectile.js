...
(function (Endabgabe) {
    ...
    Projectile.textureArrow = new f.TextureImage("./Assets/Arrow.png");
    Projectile.mtrArrow = new f.Material("Arrow", f.ShaderTexture, new f.CoatTextured(f.Color.CSS("White"), Projectile.textureArrow));
